...
type FakeConcourseEvents struct {
...
func (fake *FakeConcourseEvents) NextEvent() (atc.Event, error) {
...
func (fake *FakeConcourseEvents) NextEventCallCount() int {
	fake.nextEventMutex.RLock()
	defer fake.nextEventMutex.RUnlock()
	return len(fake.nextEventArgsForCall)
}

func (fake *FakeConcourseEvents) NextEventReturns(result1 atc.Event, result2 error) {
...
func (fake *FakeConcourseEvents) NextEventReturnsOnCall(i int, result1 atc.Event, result2 error) {
	fake.NextEventStub = nil
...
func (fake *FakeConcourseEvents) Close() error {
...
func (fake *FakeConcourseEvents) CloseCallCount() int {
	fake.closeMutex.RLock()
	defer fake.closeMutex.RUnlock()
	return len(fake.closeArgsForCall)
}

func (fake *FakeConcourseEvents) CloseReturns(result1 error) {
	fake.CloseStub = nil
...
func (fake *FakeConcourseEvents) CloseReturnsOnCall(i int, result1 error) {
	fake.CloseStub = nil
...
func (fake *FakeConcourseEvents) Invocations() map[string][][]interface{} {
...
func (fake *FakeConcourseEvents) recordInvocation(key string, args []interface{}) {
